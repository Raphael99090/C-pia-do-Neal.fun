  ...
  const games = [
    {
      ...
      name: "Aim Trainer",
      category: "Reflexes",
      description: "Hit targets as fast as possible",
    ...
    },
    {
      ...
      name: "Color Genius",
      category: "Brain",
      description: "Stroop effect test - pick the color, not the word",
    ...
    },
    {
      ...
      name: "Quick Math",
      category: "Brain",
      description: "Solve simple math expressions fast",
    ...
    },
    {
      ...
      category: "Memory",
      description: "Repeat the ever-growing light and sound pattern",
    ...
    },
    {
      ...
      name: "Vocab Master",
      category: "Brain",
      description: "Guess the meaning of difficult words",
    ...
    },
    {
      ...
      name: "Tower Stacker",
      category: "Precision",
      description: "Stack the neon blocks as high as you can",
      icon: <Layers size={32} />,
    ...
    },
    {
      ...
      name: "MPC Pad",
      category: "Music",
      description: "Play drums and synths",
      icon: <Music4 size={32} />,
    ...
    },
    {
      ...
      name: "Kaleidoscope",
      category: "Creative",
      description: "Draw symmetrical mandala art",
      icon: <Brush size={32} />,
    ...
    },
    {
      ...
      name: "Theremin",
      category: "Creative",
      description: "Play an ethereal digital synthesizer",
    ...
    },
    {
      ...
      name: "Pixel Studio",
      category: "Creative",
      description: "Draw retro 16x16 pixel art",
    ...
    },
    {
      ...
      name: "Sandworld",
      category: "Physics",
      description: "Falling sand physics simulation",
    ...
    },
    {
      ...
      category: "Logic",
      description: "Combine elements with AI",
      icon: <Beaker size={32} />,
    ...
    },
    {
      ...
      name: "Particle Flow",
      category: "Visual",
      description: "Atmospheric particle physics simulation",
      icon: <Wind size={32} />,
    ...
    },
    {
      ...
      name: "Orbits",
      category: "Physics",
      description: "Simulate gravity and orbiting bodies",
      icon: <Circle size={32} />,
    ...
    },
    {
      ...
      name: "Speed Match",
      category: "Brain",
      description: "Match shapes and colors as fast as you can",
      icon: <Zap size={32} />,
